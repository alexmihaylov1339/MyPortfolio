...
- Latest completed step: `step-3-portfolio-dashboard.md`.
- Current active step: `step-4-model-portfolio.md` (in progress).
- Next planned steps: `step-5-rebalance-comparison.md`, `step-6-market-prices.md`.
