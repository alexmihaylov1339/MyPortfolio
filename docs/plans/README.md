...
- Current active step: `step-3-portfolio-dashboard.md` (in progress).
- Next planned steps: `step-4-model-portfolio.md`, `step-5-rebalance-comparison.md`, `step-6-market-prices.md`.
