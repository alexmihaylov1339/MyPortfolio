...
- Latest completed step: `step-4-model-portfolio.md`.
- Current active step: `step-5-rebalance-comparison.md` (in progress).
- Next planned steps: `step-6-market-prices.md`.
